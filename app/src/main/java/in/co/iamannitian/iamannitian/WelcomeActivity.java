...
public class WelcomeActivity extends AppCompatActivity {
    ...
    final String[] linksList = new String[]{"https://www.instagram.com/i_am_an_nitian/","https://www.facebook.com/iamannitian","https://www.youtube.com/channel/UCnONMgL4R7ptGLHIK0KaMCQ","https://iamannitian.co.in/",};
                ...
                public void onClick(View v) {
                    if(index!=1) {
                        ...
                        try {
                            ...
                            startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse(linksList[1])));
                        }
    ...
    private void setUpToolBar() {
        ...
        abdt = new ActionBarDrawerToggle(WelcomeActivity.this,drawerLayout,R.string.open_drawer,R.string.close_drawer);
